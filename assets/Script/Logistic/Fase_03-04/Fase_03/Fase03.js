cc.Class({
    ...
    question: function(){
        ...
        if(this.questionControler == 1){
              ...
              if(options == 'opção B'){
                console.log("Fase 03, questao 01 resposta certa "+options);  
                  ...
                  this.addScore(100 );//adiciona a pontuação
                    ...
                    console.log("Fase 03, questao 01 resposta errada "+options);  
        ...
        if(this.questionControler == 2){
              if(options == 'opção D'){
                console.log("Fase 03, questao 02 resposta certa "+options);  
                  this.hudQuestion.active = false;  
                  this.questionCorrect1.active = true;
                  this.addScore(100 );

                }else{
                console.log("Fase 03, questao 02 resposta errada "+options);   
                  this.hudQuestion.active = false;   
        ...
        if(this.questionControler == 3){
            console.log("Fase 03, questao 03 resposta certa "+options);  
            if(options == 'opção C'){
                this.hudQuestion.active = false;  
                this.questionCorrect1.active = true;
                this.addScore(100 );
            ...
            console.log("Fase 03, questao 03 resposta errada "+options);      
                this.hudQuestion.active = false;   
                this.questionErase.active = true;
        ...
        if(this.questionControler == 4){
            ...
            if(options == 'opção A'){
                console.log("Fase 03, questao 04 resposta certa "+options);      
                this.hudQuestion.active = false;   
                this.questionCorrect1.active = true;
                this.addScore(100 );
              }else{
                console.log("Fase 03, questao 04 resposta errada "+options);    
                this.hudQuestion.active = false;   
                this.questionErase.active = true;
        ...
        if(this.questionControler == 5){
            ...
            if(options == 'opção D'){
                console.log("Fase 03, questao 05 resposta certa "+options);  
                this.hudQuestion.active = false;  
                this.questionCorrect1.active = true;
                this.addScore(100 );

            }else{
                console.log("Fase 03, questao 05 resposta errada "+options);  
                this.hudQuestion.active = false;   
                this.questionErase.active = true;
