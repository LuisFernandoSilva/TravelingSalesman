cc.Class({
    ...
    question: function(){
        ...
        if(this.questionControler == 1){
              ...
              if(options == 'opção B'){
                console.log("Fase 04 extra, questao 01 resposta certa "+options);  
                ...
                console.log("Fase 04 extra, questao 01 resposta errada "+options);  
                  this.addScore(0);  
        ...
        if(this.questionControler == 2){
              if(options == 'opção D'){
                console.log("Fase 04 extra , questao 02 resposta certa "+options);    
                  this.hudQuestion.active = false;  
                  this.questionCorrect1.active = true;
                  this.addScore(100 + numero);

                }else{
                console.log("Fase 04 extra, questao 02 resposta errada "+options);   
                  this.hudQuestion.active = false;   
        ...
        if(this.questionControler == 3){
            if(options == 'opção C'){
                console.log("Fase 04 extra, questao 03 resposta certa "+options); 
                this.hudQuestion.active = false;  
                this.questionCorrect1.active = true;
                this.addScore(100 + numero);

            }else{
                console.log("Fase 04 extra, questao 03 resposta errada "+options); 
                this.hudQuestion.active = false;   
                this.questionErase.active = true;
